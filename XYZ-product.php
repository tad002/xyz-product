...
class XYZProduct {
	public static function initialize() {
		add_action( 'init', array( get_called_class(), 'add_xyz_product' ) );
		add_action( 'admin_init', array( get_called_class(), 'xyz_product_admin' ) );
		add_action( 'save_post', array( get_called_class(), 'add_xyz_product_details', 10, 2 ) );

	}

	public static function add_xyz_product() {
	...
	public static function xyz_product_admin() {
		add_meta_box( 'xyz_product_meta_box',
			'Product Details',
			array( get_called_class(), 'display_xyz_product_meta_box' ),
			'xyz_product',
			'normal',
			'high'
		);
	...
	public static function display_xyz_product_meta_box( $xyz_product ) {
		...
		<table>
			...
			<tr>
				...
				<td class="tabbed"><input type="text" size="80" name="xyz_product_height"
				                          value="<?php echo $height; ?>"/>
				</td>
			</tr>
			<tr>
				<td>Product Weight</td>
				<td class="tabbed"><input type="text" size="80" name="xyz_product_weight"
	...
	public static function add_xyz_product_details( $xyz_product_id, $xyz_product ) {
